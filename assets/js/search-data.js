...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "repositories",
          description: "All relevant robotics repositories.",
          section: "Navigation",
          handler: () => {
      ...
      },{id: "books-the-origins-of-political-order-from-prehuman-ties-to-the-french-revolution",
          title: 'The Origins of Political Order - From Prehuman Ties to the French revolution...',
          description: "",
          section: "Books",handler: () => {
              window.location.href = "/books/fukuyama/";
